...
description: Classify, inventory, check completeness, and issue-spot a legal document before deeper review.
---

# Document onboarding

Treat onboarding as the legal intake gate. Preserve the source document and distinguish observed
facts from assumptions. Identify the document type, apparent parties, dates, version clues, clause
topics, missing components, and issues that should trigger a deeper workflow.
